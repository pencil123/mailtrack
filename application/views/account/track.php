...
<div id="manage-tab">
    <div class="Gq">
    <div class="d6">
    <span class="en zl"><span class="Jw e">追踪</span></span>
...
<div class="item">
    <label>邮箱</label>
    <input id="email" class="basic-input" type="text" tabindex="1" value = "<?php echo $mail;?>" maxlength="60" name="email" autocomplete="off" placeholder="您的邮箱地址" style="width:260px;">
</div>
...
<div class="item img-item">
    <label>图片<span id="image_tooltip" class="help-tooltip" title="图片"></span></label>
    <span class="image-select-area"><img src="/images/cleardot.gif" id="selected_image" style="display:none;">
    <span id="selected_image_text"></span>&nbsp;<a href="#" class="image-select" id="imgsel">请选择</a></span>
...
<div id="track-container">
    <div id="track-help">点击上面的按钮，您会在下面看到您的邮件追踪图片。您只需复制这张图片并粘贴到邮件内容中，然后照常发送邮件即可。
    </div>
<div id="track-ad" style="padding-top:8px;"></div>
    <p id="track-image-container"><img src="/images/cleardot.gif" id="i_f_t" style="display:none;">
    <span id="track-message"></span></p>
</div>
